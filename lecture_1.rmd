...
* 10 groups, 5 obs/group, effects/group
...
- e.g. bloodworm example: 5×4×4×2 factorial design (160 combinations), all measured in each of 10 individuals. 
    - Treating covariates as numeric, allow all interactions: 16 effects → $p=136$
    - Categorical predictors, no interactions: 12 effects → $p=78$
    - Numeric predictors, no interactions: 4 effects → $p=10$
- ignoring within-cluster effects is also dangerous [@schielzeth_conclusions_2009; @heisigWhy2019a; @oberauerImportance2022]
